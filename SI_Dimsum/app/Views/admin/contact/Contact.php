...
<html lang="en">
  ...
  <body>
    ...
    <div class="content-wrapper">
      ...
      <div class="page-wrapper">
        ...
        <a class=" btn btn-primary mb-3" href="<?php echo base_url('tambahContact') ?>" role="button"><i class="fa fa-plus"></i>Tambah</a>
  ...
  <tbody>
    ...
    <tr>
      ...
      <th scope="row"><?= $no ?></th>
      <td><?php echo "<img src='Assets/AdminLTE-3.2.0/dist/img/$pr[foto] 'width='70' height='90'/>"?></td>
      <td><?= $pr['nama'] ?></td>
      <td><?= $pr['npm'] ?></td>
      <td>
        <div class="d-flex">
          <a class="btn btn-warning mr-3" href="/editContact/<?php echo $pr['id'] ?>"><i class="fa fa-edit"></i> Edit</a>
          <form action="/deleteContact/<?php echo $pr['id'] ?>" method="post">
