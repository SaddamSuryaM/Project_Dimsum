  ...
  <div class="content-wrapper">
    ...
    <nav class="navbar">
      <div class="navbar-left">
        ...
        <a class="link-item  active" href="<?php echo base_url('Teams') ?>">
          <span class="icon"></span>
    ...
    <div class="page-wrapper">
      <div class="card">
        <form action="/updateContact/<?= $nama['id'] ?>" method="POST" enctype="multipart/form-data">
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <input class="form-control" type="file" name="foto" id="foto" value="<?= $nama['foto'] ?>">
            </div>
            <div class="mb-3">
              <label for="nama">Nama</label>
              <input class="form-control" type="text" name="nama" id="nama" value="<?= $nama['nama'] ?>">
            </div>
            <div class="mb-3">
              <label for="npm">NPM</label>
              <input class="form-control" type="text" name="npm" id="npm" value="<?= $nama['npm'] ?>">
            </div>
          </div>
          <div class="card-footer">
            <button class="btn" type="reset">Hapus Data</button>
            <a href="<?php echo base_url('Teams') ?>"><button class="btn" type="button">Cancel</button></a>
