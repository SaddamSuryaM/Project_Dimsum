        ...
        <form action="/updateProduk/<?= $produk['id'] ?>" method="POST" enctype="multipart/form-data">
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <input class="form-control" type="text" name="produk" id="produk" value="<?= $produk['produk'] ?>">
            </div>
            <div class="mb-3">
              <label for="foto">Gambar</label>
              <input class="form-control" type="file" name="foto" id="foto" value="<?= $produk['foto'] ?>">
            </div>
            <div class="mb-3">
              <label for="desk">Deskripsi</label>
              <input class="form-control" type="text" name="desk" id="desk" value="<?= $produk['desk'] ?>">
            </div>
            <div class="mb-3">
